<template>
  <div class="bj-ft">
    ...
    >
      ...
      <m-card style="width: 100%" title="三农要闻">
        <div v-for="(c, i) in notice" :key="i" class="d-flex jc-between mb-2">
...
export default {
  ...
  methods: {
    async fetchNoticeCats() {
      const res = await this.$http.get("notice/list/more");
